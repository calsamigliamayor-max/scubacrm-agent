...
- ⚠️ MUY IMPORTANTE sobre el caso (d): NO hace falta que sean "varios días de buceo" para que cuente como pack a medida — un curso normal de 3 días con UN SOLO día añadido (ej. Open Water + 1 día de Shark Conservation) YA es un pack a medida. NUNCA lo registres con el service del curso solo (ej. "Open Water Course") dejando el segundo servicio solo en notes: así el manager pierde ese servicio de la factura y del calendario — usa SIEMPRE "Personalized fun dive pack" + days en estos casos, tal como se explica abajo.
        ...
        days: {
          ...
          items: {
            ...
            properties: {
              ...
              price:        { type: 'integer', description: 'Precio de ESE día en PHP, equipo de alquiler incluido si ese día es "extra". Reparte el precio total del pack entre los días de forma razonable (por servicio/sitio, no a partes iguales si los sitios tienen precios distintos) — la suma de todos los `price` debe coincidir con totalPrice.' },
            },
